...
contract IGeneScienceV9 {
    ...
    function getStrength(uint256 _talents, address _resourceToken, uint256 _landTokenId, uint256 _preferExtra, uint256 _classEnhance) public view returns (uint256 miningStrength);
